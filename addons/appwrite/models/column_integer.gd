class_name AppwriteColumnInteger
extends RefCounted
## ColumnInteger[br]
...
var default: int ## Default value for column when not provided. Cannot be set when column is required.

## Convert dictionary to model
static func from_dict(dict: Dictionary):
    var m := AppwriteColumnInteger.new()
