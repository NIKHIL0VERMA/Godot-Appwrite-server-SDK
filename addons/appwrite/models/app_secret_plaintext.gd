class_name AppwriteAppSecretPlaintext
extends RefCounted
## AppSecretPlaintext[br]
...
var secret: String ## Application client secret. Returned in full only when the secret is created; subsequent reads return a masked value.
...
static func from_dict(dict: Dictionary):
    var m := AppwriteAppSecretPlaintext.new()
