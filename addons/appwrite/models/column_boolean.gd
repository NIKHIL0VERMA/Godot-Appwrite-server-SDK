class_name AppwriteColumnBoolean
extends RefCounted
## ColumnBoolean[br]
...
var default: bool ## Default value for column when not provided. Cannot be set when column is required.

## Convert dictionary to model
static func from_dict(dict: Dictionary):
    var m := AppwriteColumnBoolean.new()
