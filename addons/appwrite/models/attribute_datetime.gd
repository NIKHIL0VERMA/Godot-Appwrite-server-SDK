class_name AppwriteAttributeDatetime
extends RefCounted
## AttributeDatetime[br]
...
var format: String ## ISO 8601 format.
var default: String ## Default value for attribute when not provided. Only null is optional

## Convert dictionary to model
static func from_dict(dict: Dictionary):
    var m := AppwriteAttributeDatetime.new()
