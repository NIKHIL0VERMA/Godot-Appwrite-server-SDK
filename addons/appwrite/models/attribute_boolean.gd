class_name AppwriteAttributeBoolean
extends RefCounted
## AttributeBoolean[br]
...
var default: bool ## Default value for attribute when not provided. Cannot be set when attribute is required.

## Convert dictionary to model
static func from_dict(dict: Dictionary):
    var m := AppwriteAttributeBoolean.new()
