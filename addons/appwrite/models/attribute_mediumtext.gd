class_name AppwriteAttributeMediumtext
extends RefCounted
## AttributeMediumtext[br]
...
var default: String ## Default value for attribute when not provided. Cannot be set when attribute is required.
var encrypt: bool ## Defines whether this attribute is encrypted or not.

## Convert dictionary to model
static func from_dict(dict: Dictionary):
    var m := AppwriteAttributeMediumtext.new()
