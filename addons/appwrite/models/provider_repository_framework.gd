class_name AppwriteProviderRepositoryFramework
extends RefCounted
## ProviderRepositoryFramework[br]
...
var framework: String ## Auto-detected framework. Empty if type is not &quot;framework&quot;.

## Convert dictionary to model
static func from_dict(dict: Dictionary):
    var m := AppwriteProviderRepositoryFramework.new()
