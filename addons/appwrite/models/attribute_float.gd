class_name AppwriteAttributeFloat
extends RefCounted
## AttributeFloat[br]
...
var min: float ## Minimum value to enforce for new documents.
var max: float ## Maximum value to enforce for new documents.
var default: float ## Default value for attribute when not provided. Cannot be set when attribute is required.

## Convert dictionary to model
static func from_dict(dict: Dictionary):
    var m := AppwriteAttributeFloat.new()
