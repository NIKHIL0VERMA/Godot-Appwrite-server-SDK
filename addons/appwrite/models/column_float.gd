class_name AppwriteColumnFloat
extends RefCounted
## ColumnFloat[br]
...
var default: float ## Default value for column when not provided. Cannot be set when column is required.

## Convert dictionary to model
static func from_dict(dict: Dictionary):
    var m := AppwriteColumnFloat.new()
