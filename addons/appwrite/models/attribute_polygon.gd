class_name AppwriteAttributePolygon
extends RefCounted
## AttributePolygon[br]
...
var default: Array ## Default value for attribute when not provided. Cannot be set when attribute is required.

## Convert dictionary to model
static func from_dict(dict: Dictionary):
    var m := AppwriteAttributePolygon.new()
