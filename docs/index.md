...
Welcome to the community-maintained Appwrite SDK for Headless Godot 4.
...
For concepts, architecture, authentication, permissions, databases, functions, and backend features, always refer to: [Appwrite Docs](https://appwrite.io/docs)
