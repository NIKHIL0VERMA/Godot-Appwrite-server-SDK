...
func _ready():
    ...
    var result = await Appwrite.avatars.get_screenshot(
        ...
        1080, # optional
        2, # optional
        Appwrite.BrowserTheme.DARK, # optional
        'Mozilla/5.0 (iPhone; CPU iPhone OS 14_0 like Mac OS X) AppleWebKit/605.1.15', # optional
        true, # optional
        'en-US', # optional
        Appwrite.Timezone.AFRICA_ABIDJAN, # optional
        37.7749, # optional
        -122.4194, # optional
        100, # optional
        true, # optional
        Appwrite.[BrowserPermission.GEOLOCATION, BrowserPermission.NOTIFICATIONS], # optional
        3, # optional
        800, # optional
        600, # optional
        85, # optional
        Appwrite.ImageFormat.JPEG # optional
    )
